...
**ngx\_rewrite\_and\_auth** is an authentication module that calls multiple authentications via HTTP with a rewritten request.  
...
```
ngx_rewrite_and_auth <config file>
```
...
The **ngx\_rewrite\_and\_auth** configuration file is in TOML format, and the following is a sample configuration file.
...
### **\[and.response.bad\_request\]** part
...
### **\[and.response.bad\_gateway\]** part
...
### **\[and.response.invalid\_setting\]** part
